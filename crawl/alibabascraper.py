...
import configparser
import json
from crawl.models import flight, hotel
                            ...
                            if s != d:
                                try:
                                    ...
                                    for df in departing_flights:
                                        f = flight.flight(df['originName'], df['destinationName'], df['leaveDateTime'],
                                                          df['arrivalDateTime'],
                                                          df['priceAdult'], df['airlineName'])
                                        flights.append(f)

                                    for rf in returning_flights:
                                        f = flight.flight(rf['originName'], rf['destinationName'], rf['leaveDateTime'],
                                                          rf['arrivalDateTime'],
